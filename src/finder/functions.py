...
def display_peaks_3d(image:np.array, peaks:list, threshold:int, img_threshold:float=0.005) -> None:
...
def display_peaks_3d_beamstop(image:np.array, threshold_value:int) -> None:
